...
const SignupForm = () => {
  ...
  async function onSubmit(values: z.infer<typeof SignupValidation>) {
    ...
    if(isLoggedIn){
      ...
      return toast({title:"Sign up2 failed. Please try again"})
    } 
  ...
  return (
    <Form {...form}>
      <div className="sm:w-420 flex-center flex-col">
        ...
        <p className="text-light-3 small-medium md:base-reguler mt-2">To use SocialFess, please enter your details</p>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-5 w-full mt-4">
          ...
          <p className="text-small-reguler text-light-2 text-center mt-2">
            ...
            <Link to='/sign-in' className="text-primary-500 text-small-bold ml-1">
              Sign in
            </Link>
          </p>
        </form>
